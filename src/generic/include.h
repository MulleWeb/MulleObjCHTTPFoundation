#ifndef mulle_objc_http_foundation_include_h__
#define mulle_objc_http_foundation_include_h__
...
/* This is a central include file to keep dependencies out of the library
   ...
   not "MulleObjCHTTPFoundation-include.h" to keep the #include statements in the
...
#ifndef MULLE_OBJC_HTTP_FOUNDATION_EXTERN_GLOBAL
# define MULLE_OBJC_HTTP_FOUNDATION_EXTERN_GLOBAL MULLE_C_EXTERN_GLOBAL
#endif
