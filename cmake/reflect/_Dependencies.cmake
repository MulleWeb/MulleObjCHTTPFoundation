      ...
      if( MULLE_OBJC_INET_FOUNDATION_LIBRARY)
         ...
         foreach( _TMP_MULLE_OBJC_INET_FOUNDATION_NAME "MulleObjCInetFoundation")
            ...
            if( IS_DIRECTORY "${_TMP_MULLE_OBJC_INET_FOUNDATION_DIR}")
               ...
               unset( MULLE_OBJC_INET_FOUNDATION_RENDEZVOUS_GLOBALS)
               ...
               include( "${_TMP_MULLE_OBJC_INET_FOUNDATION_DIR}/Definitions.cmake" OPTIONAL)
               list( APPEND RENDEZVOUS_GLOBALS ${MULLE_OBJC_INET_FOUNDATION_RENDEZVOUS_GLOBALS})
               break()
            else()
         ...
         if( NOT NO_INHERIT_OBJC_DEPS)
            foreach( _TMP_MULLE_OBJC_INET_FOUNDATION_NAME "MulleObjCInetFoundation")
               set( _TMP_MULLE_OBJC_INET_FOUNDATION_FILE "${_TMP_MULLE_OBJC_INET_FOUNDATION_ROOT}/include/${_TMP_MULLE_OBJC_INET_FOUNDATION_NAME}/MulleObjCDeps+${_TMP_MULLE_OBJC_INET_FOUNDATION_NAME}.h")
               if( EXISTS "${_TMP_MULLE_OBJC_INET_FOUNDATION_FILE}")
                  list( APPEND INHERITED_OBJC_DEPS ${_TMP_MULLE_OBJC_INET_FOUNDATION_FILE})
                  break()
               endif()
            endforeach()
         endif()
